<?php
/**
 * Template Name: Cryo-Electron Microscopy Page
 * Description: Cryo-Electron Microscopy pages pulling header from ACF page ID 1642 with SVGs and fail-safe ACF logic.
 */
