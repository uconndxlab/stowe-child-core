<?php
/**
 * Template Name: Flow Cytometry Page
 * Description: Flow Cytometry pages pulling header from ACF page ID 474 with SVGs and fail-safe ACF logic.
 */
